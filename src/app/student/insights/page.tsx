...
import { BarChart2, Sparkles, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="p-8 sm:p-12 rounded-3xl bg-white border border-slate-200/90 shadow-sm text-center space-y-6 max-w-xl mx-auto">
      ...
      <div className="space-y-2">
        ...
        <h2 className="text-xl font-bold text-slate-900">Personal Execution Insights</h2>
        <p className="text-xs text-slate-500 leading-relaxed">
          Weekly on-time completion rates, peak study performance hours, and academic focus metrics.
        </p>
      </div>
