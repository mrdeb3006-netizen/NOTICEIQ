...
import { PriorityTask, TaskQuadrant } from "@/types/student";
...
export default function StudentPriorityMatrixPage() {
  ...
  const searchFilter = (task: PriorityTask) => {
    ...
    return (
      ...
      task.noticeTitle.toLowerCase().includes(term) ||
  ...
  // Group active tasks into Quadrants
  const q1Tasks = filteredActiveTasks.filter((t) => t.quadrant === "Q1");
  const q2Tasks = filteredActiveTasks.filter((t) => t.quadrant === "Q2");
  const q3Tasks = filteredActiveTasks.filter((t) => t.quadrant === "Q3");
  const q4Tasks = filteredActiveTasks.filter((t) => t.quadrant === "Q4");
    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-24 text-left">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5 self-start sm:self-auto flex-wrap">
          ...
          <Link
            href="/student/inbox"
            className="px-3.5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold shadow-sm shadow-indigo-600/20 transition-all flex items-center gap-1.5"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="p-5 rounded-3xl bg-white border-2 border-amber-200/90 shadow-sm flex flex-col justify-between space-y-4">
            <div className="space-y-3">
              ...
              <p className="text-[11px] text-slate-500 font-medium leading-relaxed">
                Important academic tasks, fellowship proposals, and long-range study goals. Schedule focused blocks.
              </p>
